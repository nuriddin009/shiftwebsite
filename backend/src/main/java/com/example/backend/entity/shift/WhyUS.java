...
public class WhyUS {
    ...
    private String filePath = "/home/whyus/" + getId();

    public WhyUS(String title, String description, String title_UZB, String title_RUS, String description_UZB, String description_RUS, Attachment attachment) {
        this.title = title;
